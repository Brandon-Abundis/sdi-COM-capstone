      ...
      {userData.is_active === true ? (
        <div className="relative min-h-screen w-full bg-base-300">
          <button
            ...
            className="absolute top-4 right-4 z-50 px-4 py-2 bg-error/10 hover:bg-error hover:text-white text-error text-xs font-black uppercase tracking-widest border border-error/20 rounded-lg transition-all duration-300 backdrop-blur-sm"
          >
            Sign Out
          </button>
