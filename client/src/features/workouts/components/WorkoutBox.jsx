  ...
  return (
    ...
    >
      <div className="text-lg font-bold rounded-t-lg h-[20%] flex items-center justify-between">
        <h2 className={`${completed ? "text-green-500" : ""} break-all ml-2 bg-base-100 p-2 rounded-md border-2 border-secondary/50 w-60 h-18 flex items-center justify-center`}>
          {title}
        </h2>
        <Icon type={type} />
      </div>
      <div className="m-4 w-60 h-49 bg-base-100 flex flex-col justify-around rounded-md border-secondary/40 border">
        ...
        <h2 className="text-center mt-1 font-medium"> {updated_at.toDateString()} </h2>
